...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.dxc.clientDemo.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8181/clientDemo/services/Hello";
    ...
    public com.dxc.clientDemo.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dxc.clientDemo.HelloSoapBindingStub _stub = new com.dxc.clientDemo.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.dxc.clientDemo.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dxc.clientDemo.HelloSoapBindingStub _stub = new com.dxc.clientDemo.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://clientDemo.dxc.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://clientDemo.dxc.com", "Hello"));
        }
